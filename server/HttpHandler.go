...
func ServeWS(s *WSServer, w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
...
func Login(s *WSServer, w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
